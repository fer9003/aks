...
- **Project details**
  ...
  - Resource Group: <colocar_su_resourcegroup>
- **Server Details**
...
```
 - **Deploy Manifest**
```
kubectl apply -f 01.service-externalname-mysql.yaml
```
...
kubectl apply -f storage-externaldb-azuremysql/
...
kubectl delete -f storage-externaldb-azuremysql/
